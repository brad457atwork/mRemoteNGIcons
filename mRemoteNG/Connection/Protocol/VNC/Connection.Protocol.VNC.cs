...
namespace mRemoteNG.Connection.Protocol.VNC
{
    public class ProtocolVNC : ProtocolBase, ISupportsViewOnly
    {
        ...
        public override bool Initialize()
        {
            ...
            catch (Exception ex)
            {
                Runtime.MessageCollector.AddMessage(Messages.MessageClass.ErrorMsg,
                                                    mRemoteNG.Resources.Language.VncSetPropsFailed + Environment.NewLine + ex.Message,
                                                    true);
                return false;
            }
        }
        ...
        public override bool Connect()
        {
            ...
            {
                Runtime.MessageCollector.AddMessage(Messages.MessageClass.ErrorMsg,
                                                    mRemoteNG.Resources.LanguageConnectionOpenFailed + Environment.NewLine +
                                                    ex.Message);
                return false;
            }
        ...
        public override void Disconnect()
        {
            ...
            {
                Runtime.MessageCollector.AddMessage(Messages.MessageClass.ErrorMsg,
                                                    mRemoteNG.Resources.LanguageVncConnectionDisconnectFailed + Environment.NewLine +
                                                    ex.Message, true);
            }
        }
        ...
        public void SendSpecialKeys(SpecialKeys Keys)
        {
            ...
            {
                Runtime.MessageCollector.AddMessage(Messages.MessageClass.ErrorMsg,
                                                    mRemoteNG.Resources.LanguageVncSendSpecialKeysFailed + Environment.NewLine +
                                                    ex.Message, true);
            }
        }
        ...
        public void ToggleSmartSize()
        {
            ...
            {
                Runtime.MessageCollector.AddMessage(Messages.MessageClass.ErrorMsg,
                                                    mRemoteNG.Resources.LanguageVncToggleSmartSizeFailed + Environment.NewLine +
                                                    ex.Message, true);
            }
        }
        ...
        public void ToggleViewOnly()
        {
            ...
            {
                Runtime.MessageCollector.AddMessage(Messages.MessageClass.ErrorMsg,
                                                    mRemoteNG.Resources.LanguageVncToggleViewOnlyFailed + Environment.NewLine +
                                                    ex.Message, true);
            }
        }
        ...
        public void RefreshScreen()
        {
            ...
            {
                Runtime.MessageCollector.AddMessage(Messages.MessageClass.ErrorMsg,
                                                    mRemoteNG.Resources.LanguageVncRefreshFailed + Environment.NewLine + ex.Message,
                                                    true);
            }
        }
        ...
        private void SetEventHandlers()
        {
            ...
            {
                Runtime.MessageCollector.AddMessage(Messages.MessageClass.ErrorMsg,
                                                    mRemoteNG.Resources.LanguageVncSetEventHandlersFailed + Environment.NewLine +
                                                    ex.Message, true);
            }
        }
        ...
        {
            [LocalizedAttributes.LocalizedDescription(nameof(mRemoteNG.Resources.Language.NoCompression))]
            CompNone = 99,
        ...
        public enum AuthMode
        {
            ...
            [LocalizedAttributes.LocalizedDescription(nameof(mRemoteNG.Resources.Language.Windows))]
            AuthWin
        }

        public enum ProxyType
        {
            [LocalizedAttributes.LocalizedDescription(nameof(mRemoteNG.Resources.Language.None))]
            ProxyNone,

            [LocalizedAttributes.LocalizedDescription(nameof(mRemoteNG.Resources.Language.Http))]
            ProxyHTTP,

            [LocalizedAttributes.LocalizedDescription(nameof(mRemoteNG.Resources.Language.Socks5))]
            ProxySocks5,

            [LocalizedAttributes.LocalizedDescription(nameof(mRemoteNG.Resources.Language.UltraVncRepeater))]
            ProxyUltra
        }

        public enum Colors
        {
            [LocalizedAttributes.LocalizedDescription(nameof(mRemoteNG.Resources.Language.Normal))]
            ColNormal,
        ...
        {
            [LocalizedAttributes.LocalizedDescription(nameof(mRemoteNG.Resources.Language.NoSmartSize))]
            SmartSNo,

            [LocalizedAttributes.LocalizedDescription(nameof(mRemoteNG.Resources.Language.Free))]
            SmartSFree,

            [LocalizedAttributes.LocalizedDescription(nameof(mRemoteNG.Resources.Language.Aspect))]
            SmartSAspect
        }
